...
const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_i40e02m", // Replace with your EmailJS service ID
        "template_mnp3tt4", // Replace with your EmailJS template ID
        formRef.current,
        "luVm1P-WYXb65SQSu" // Replace with your EmailJS user ID
      )
      .then(
        (result) => {
